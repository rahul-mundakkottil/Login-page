    ...
    return( <View style= {styles.container}>
      <Image source={require('../assets/image.jpg')} style={styles.bgimagestyle}></Image>
       ...
       <TouchableHighlight style={styles.buttonstyle1} 
             ...
             onPress={()=> this.props.navigation.navigate('Sign_in',{ username:this.state.name})}>
              <Text style={styles.buttontext}>Sign in</Text>
             </TouchableHighlight>
             <View style={{flexDirection:'row'}}>
              <Text style={{marginRight:100,marginTop:10}}>Haven't registered yet?</Text>
              <TouchableHighlight style={{marginTop:10}}  onPress={()=> this.props.navigation.navigate('Drawer')}><Text style={{color:'red'}}>Join Now</Text></TouchableHighlight>
             </View>
